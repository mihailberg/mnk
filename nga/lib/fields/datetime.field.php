<?php
class field_datetime extends fieldGeneral implements fieldI{
	...
	<tr>
        ...
        <td><input type="text" class="field form datepicker" style="width:100%" name="'.$this->sqlField.'" value="'.$this->value.'" maxlength="255" /></td>
	</tr>
	';
		return $html;
	}	
