...
class field_multifile extends field_nodb implements fieldI
{
    ...
    public function getForm()
    {
        ...
        $html = '
              ...
              $(document).ready(function() {
                  ...
                  $(\'.multiupload.multifile' . $this->fk_type . $this->fk_value . '\').fineUploader({
                      debug: true,
                      request: {
                          endpoint: "/services/fileUpload.php",
                          paramsInBody: true,
                          params: {
                              R_TYPE: \'' . $this->fk_type . '\',
                              R_ID: \'' . $this->fk_value . '\',
              ...
              <ul class="multiupload multifile' . $this->fk_type . $this->fk_value . ' stylemulti"></ul>
              <iframe class="subiframe' . $this->fk_type . $this->fk_value . ' subiframe multifile" style="border:0px; width:100%;" src="/admin/' . $this->table . '.php?gid=' . $this->fk_value . '&R_TYPE=' . $this->fk_type . '"></iframe>
...
';
    ...
    {
        $this->fk_value = ((int)$_GET['id']);
        return '<iframe class="subiframe' . $this->fk_type . $this->fk_value . ' subiframe multifile" style="border:0px; width:100%;" src="/admin/' . $this->table . '.php?gid=' . $this->fk_value . '&R_TYPE=' . $this->fk_type . '"></iframe>';
    }
